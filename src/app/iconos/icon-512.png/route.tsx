...
// Icono PWA 512 generado en servidor (antes eran PNG estáticos del monograma
// "CB"; ahora es la nube de marca). Ruta estable: /iconos/icon-512.png.
...
export function GET() {
  return new ImageResponse(
    (
      ...
      <img src={comoDataUri(iconoNubeSvg(512))} width={512} height={512} alt="" />
    ),
