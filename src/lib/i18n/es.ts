...
export const es = {
  ...
  "tienda.orden.precioAsc.aria": "Precio: de menor a mayor",
  "tienda.orden.precioDesc.aria": "Precio: de mayor a menor",
  ...
  "producto.agregar": "Añadir al carrito",
  "producto.verCarrito": "Ver el carrito",
  "producto.cantidad": "Cantidad",
  "producto.cantidad.menos": "Quitar una unidad",
  "producto.cantidad.mas": "Añadir una unidad",
  ...
  "regalo.producto": "Tarjeta regalo · Cloud Beauty Salon",
  "regalo.importe": "Importe",
  "regalo.importe.otro": "Otro",
  "regalo.destinatario": "Email de quien lo recibe",
  "regalo.comprador": "Tu email",
  "regalo.mensaje": "Mensaje (opcional)",
  "regalo.comprar": "Comprar · {importe}",
  "regalo.enviando": "Redirigiendo al pago…",
  "regalo.error": "No se pudo iniciar la compra. Inténtalo de nuevo.",
  ...
  "resenas.email": "Tu email (opcional)",
  "resenas.email.ayuda":
    "Si compraste este producto con este email, tu reseña se marca como compra verificada. No se publica.",
  "resenas.foto": "Añadir una foto (opcional)",
  "resenas.verificada": "Compra verificada",
  ...
  "carrito.anadido": "Añadido al carrito",
  ...
  "carrito.linea.sumar": "Añadir una unidad de {nombre}",
  ...
  "carrito.sugerencias": "También te puede gustar",
  ...
  "quiz.resultado.agregarTodo": "Añadir todo al carrito",
